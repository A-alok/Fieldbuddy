...
class CropRecommendationResult(QWidget):
    ...
    def get_crop_image_path(self):
        ...
        base_paths = [
            os.path.join(os.path.dirname(os.path.abspath(__file__)), "images", "crops"),
            os.path.join(os.path.dirname(os.path.abspath(__file__)), "assets", "crops"),
        ...
        return os.path.join(os.path.dirname(os.path.abspath(__file__)), "images", "placeholder.png")
